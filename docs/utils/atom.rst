...
.. cpp:function:: int getZFromSymb(const std::string &symb)
    ...
    Returns the atomic number of a given symbol. If passed "D" or "T", it will return `1`, as these refer to deuterium and tritium. If the string is not a symbol, it will return `0`.
...
.. cpp:class:: Atom : Copyable
    ...
    .. cpp:function:: double getz() const
        ...
        Returns the components of the position.
